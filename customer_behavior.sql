...
SELECT
	ROUND(AVG(purchase_amount),2 ) as Amount_USD,
	shipping_type
FROM
	customer
WHERE
...
--Q5. Do subscribed customers spend more? Compare the average spend and total revenue between subscibers and non-subscribers.
SELECT
	subscription_status,
...
SELECT
	item_purchased,
	ROUND(SUM(CASE WHEN discount_applied = 'Yes' THEN 1 ELSE 0 END )*100/COUNT(*),2) as dis count_rate
FROM 
	customer
GROUP BY
	item_purchased
